...
import { supabase, getOrCreateGeneralBoardForClient } from '../lib/supabase'
...
export default function ClientDashboard() {
  ...
  const handleSubmitRequest = async () => {
    ...
    try {
      // Default to this client's General Tasks board (find or create)
      const { data: boardId, error: boardError } = await getOrCreateGeneralBoardForClient(clientData?.id, user?.id)
      if (boardError || !boardId) {
        toast({
          title: 'Error',
          description: 'Could not find or create a board for this client.',
          variant: 'destructive',
        })
      ...
      // Create the ticket - ticket_id is auto-generated by database trigger
